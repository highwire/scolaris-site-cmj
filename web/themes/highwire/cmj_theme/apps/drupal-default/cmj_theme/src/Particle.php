...
class Particle {
   ...
   */
  const THEME_NAME = 'cmj';

  /**
   * Provides the path for compiled Drupal assets in build system.
   */
  const ASSETS_PATH = 'themes/cmj/dist/app-drupal/assets';
  const IMAGES_PATH = 'themes/cmj/dist/app-drupal/assets/images';
  const FONTS_PATH = 'themes/cmj/dist/app-drupal/assets/fonts';
